...
var fileSize = 0;
// const csvURL: string =
//     "https://raw.githubusercontent.com/vamstar/challenge/master/Dataset3.csv",
//   path = "/tmp/temp.csv",
//   media = request(csvURL).pipe(fs.createWriteStream(path));
// media.on("finish", () => {
//   return fs.statSync(path).size;
// });
request
    .get("https://raw.githubusercontent.com/vamstar/challenge/master/Dataset3.csv")
